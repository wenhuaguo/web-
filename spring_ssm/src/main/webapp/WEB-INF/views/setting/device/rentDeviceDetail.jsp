                            ...
                            <form role="form" >
                                <div class="box-body" class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="" >
                                                <label for="fax">传真：&nbsp</label>
                                                <span>${companyContract.fax}</span>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div>
                                                ...
                                                <table class="table table-bordered" >
                                                    ...
                                                    <c:forEach items="${deviceList}" var="device">
                                                        <tr>
                                                            ...
                                                            <td><span>${device.unit}</span></td>
                                                            <td>${device.rentPrice}</td>
                                                            <td><span>${device.num}</span></td>
                                            ...
                                            <div style="border:1px solid #bfbfbf;">
                                                <table class="table table-bordered" >
                                                    <thead>
                                                        <tr>
                                                            <th>合同扫描件</th>
                                                            <th><a href="/business/device/rent/zip?companyId=${companyContract.id}" class="btn btn-sm btn-default"><i class="fa fa-file-archive-o" aria-hidden="true"></i>打包下载</a></th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                    <c:forEach items="${fileList}" var="file">
                                                        <tr><td><a href="/business/device/file/download?id=${file.id}">${file.sourceFileName}</a></td></tr>
                                                    </c:forEach>
                                                    </tbody>
                                                </table>
                                            </div>
